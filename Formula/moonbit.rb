...
class Moonbit < Formula
  ...
  sha256 OS.mac? ?
    if Hardware::CPU.arm?
      '23e5ab5b46239b8a6f8eae0a0f1021fa241baeca586a3d64ecfa4f985ff9cbb1'
    else
    ...
    if Hardware::CPU.arm?
      ...
      'aa87247bcf1b516043b969a9ceea43566eeeb2f90980c1c6f6d9143e1c05dbea'
    end
