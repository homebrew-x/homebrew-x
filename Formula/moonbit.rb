...
class Moonbit < Formula
  ...
  sha256 OS.mac? ?
    if Hardware::CPU.arm?
      'edf1f6e9ee2bce629e3da279d2c420249c71019da21a79d58665de31e2407606'
    else
    ...
    if Hardware::CPU.arm?
      ...
      '6432806f09d27c0d08afcdf668d3fdbb17dee883cd5fa5ac412c10773f4b17ef'
    end
