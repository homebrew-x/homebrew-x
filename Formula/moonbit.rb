...
class Moonbit < Formula
  ...
  sha256 OS.mac? ?
    if Hardware::CPU.arm?
      '3c965b8679ccbb2b707a4586a91645c24fe40033271019b99674bd4985c2574f'
    else
    ...
    if Hardware::CPU.arm?
      ...
      '4def890a344a911a85e46f8c84b1e6904a28059ab840e7c9d8c4c5ecbae8c864'
    end
